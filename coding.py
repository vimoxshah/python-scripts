...
conn.request("GET", "/calendar/feed.rss", payload, headers)
res = conn.getresponse()
data = res.read()
page = BeautifulSoup(data.decode("utf-8"),"lxml")
